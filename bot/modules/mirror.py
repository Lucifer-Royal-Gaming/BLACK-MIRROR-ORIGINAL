...
from bot import bot, Interval, INDEX_URL, BUTTON_FOUR_NAME, BUTTON_FOUR_URL, BUTTON_FIVE_NAME, BUTTON_FIVE_URL, \
                ...
                dispatcher, DOWNLOAD_DIR, download_dict, download_dict_lock, TG_SPLIT_SIZE, LOGGER, LOGS_CHATS , BOT_PM
from bot.helper.ext_utils.bot_utils import is_url, is_magnet, is_gdtot_link, is_mega_link, is_appdrive_link, is_gdrive_link, get_content_type, get_mega_link_type
...
class MirrorListener:
    ...
    def onDownloadError(self, error):
        ...
        msg = f"{self.tag} 𝐘𝐨𝐮𝐫 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐇𝐚𝐬 𝐁𝐞𝐞𝐧 𝐂𝐚𝐧𝐜𝐞𝐥𝐥𝐞𝐝 𝐂𝐮𝐳 ⇢ {error}"
