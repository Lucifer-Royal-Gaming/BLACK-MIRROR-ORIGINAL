...
'''
        ...
        sendMarkup('𝐍𝐨𝐭 𝐀𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐔𝐬𝐞𝐫. \n Join my mirror group by clicking the below button', context.bot, update, reply_markup)

def restart(update, context):
    restart_message = sendMessage("𝐁𝐨𝐭 𝐈𝐬 𝐑𝐞𝐬𝐭𝐚𝐫𝐭𝐢𝐧𝐠..🔧", context.bot, update)
    if Interval:
        Interval[0].cancel()
    alive.kill()
...
<br><br>
<b>/{BotCommands.CloneCommand}</b> [url]: Copy file/folder to Google Drive
<br><br>
<b>/{BotCommands.CountCommand}</b> [url]: Count file/folder of Google Drive
<br><br>
