...
- `LEECH_LOGS`: File the chat_id of channel were you want leech dump, its int type so put channel which starts with -100xx without ""
- `BOT_PM`: Set it true if you want mirror files in pm
...
## Deploying on Heroku
<p><a href="https://github.com/Reflection-Mirror/Reflection-Mirror-Public/tree/heroku"> <img src="https://img.shields.io/badge/Deploy%20Guide-blueviolet?style=for-the-badge&logo=heroku" width="170""/></a></p>
